	...
	'skinSimple' : {
		...
		uniforms: THREE.UniformsUtils.merge( [
...

			{
				...
				"offsetRepeat": { value: new THREE.Vector4( 1, 1, 1, 1 ) },
		...
		fragmentShader: [
			...
			"void main() {",
				...
				"vec4 colDiffuse = texture2D( tDiffuse, vUv * TexReapts);",
				...
				"#if NUM_DIR_LIGHTS > 0",
					...
					"for( int i = 0; i < NUM_DIR_LIGHTS; i++ ) {",
                        ...
                        //"vec3 dirDiffuseWeight = mix( vec3 ( dirDiffuseWeightFull ), vec3( dirDiffuseWeightHalf ), uWrapRGB );", // changed below line (**)
						"vec3 dirDiffuseWeight = mix( vec3 ( dirDiffuseWeightHalf ), vec3( dirDiffuseWeightHalf ), uWrapRGB );",  // (**)
